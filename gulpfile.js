...
gulp.task("js", function () {
  return gulp.src("./src/assets/js/script.js").pipe(gulp.dest("./dist"));
});
...
gulp.task("serve", function () {
  ...
  gulp.watch("./src/assets/js/script.js").on("change", series("js"));
...
gulp.task(
  "default",
  series("svgstore", parallel("html", "less", "js"), "serve"),
);
